...
- `pnpm --filter @workspace/gambit run dev` — run the frontend (Vite dev server)
...
- Frontend: React 19, Vite 7, Tailwind CSS 4, Radix UI, Framer Motion, chess.js, TanStack Query
- API: Express 5
...
- Bot uses minimax/alpha-beta pruning with configurable depth for difficulty
